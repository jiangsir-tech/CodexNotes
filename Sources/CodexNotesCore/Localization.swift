...
public enum L10n {
    public enum Key: String, CaseIterable, Sendable {
        ...
        case settingsGlobalHotKeyRecording = "settings.global_hot_key.recording"
        case settingsGlobalHotKeyClear = "settings.global_hot_key.clear"
        case settingsGlobalHotKeyRestoreDefault = "settings.global_hot_key.restore_default"
        case settingsGlobalHotKeyConflict = "settings.global_hot_key.conflict"
        case settingsGlobalHotKeyRegistrationFailed = "settings.global_hot_key.registration_failed"
        case settingsGlobalHotKeyInvalidShortcut = "settings.global_hot_key.invalid_shortcut"
        case settingsGlobalHotKeyAccessibilityLabel = "settings.global_hot_key.accessibility_label"
        case settingsGlobalHotKeyAccessibilityHint = "settings.global_hot_key.accessibility_hint"
        ...
        case shortcutsSectionGlobal = "shortcuts.section.global"
        case shortcutsGlobalAvailabilityNote = "shortcuts.global.availability_note"
        ...
        case shortcutsItemToggleCodexNotes = "shortcuts.item.toggle_codex_notes"
        case globalHotKeyNotSet = "global_hot_key.not_set"
        ...
        case settingsAboutSubtitle = "settings.about.subtitle"
        case settingsAboutVersion = "settings.about.version"
        case settingsAboutAuthor = "settings.about.author"
        case settingsAboutAuthorName = "settings.about.author_name"
        case settingsAboutFeedbackEmail = "settings.about.feedback_email"
        case settingsAboutFeedbackEmailAccessibilityHint = "settings.about.feedback_email.accessibility_hint"
        case settingsAboutCopyEmail = "settings.about.copy_email"
        case settingsAboutCopyEmailAccessibilityHint = "settings.about.copy_email.accessibility_hint"
        case settingsAboutEmailCopied = "settings.about.email_copied"
        case settingsAboutGitHub = "settings.about.github"
        case settingsAboutX = "settings.about.x"
        case settingsAboutGitHubAccessibilityHint = "settings.about.github.accessibility_hint"
        case settingsAboutXAccessibilityHint = "settings.about.x.accessibility_hint"
        case settingsAboutCheckUpdates = "settings.about.check_updates"
        case settingsAboutCheckUpdatesAccessibilityHint = "settings.about.check_updates.accessibility_hint"
        case settingsAboutAutomaticCheck = "settings.about.automatic_check"
        case settingsAboutAutomaticCheckDescription = "settings.about.automatic_check.description"
        case settingsAboutChecking = "settings.about.checking"
        case settingsAboutUpToDate = "settings.about.up_to_date"
        case settingsAboutUpdateAvailable = "settings.about.update_available"
        case settingsAboutViewUpdate = "settings.about.view_update"
        case settingsAboutViewUpdateAccessibilityHint = "settings.about.view_update.accessibility_hint"
        case settingsAboutUpdateFailed = "settings.about.update_failed"
        case settingsAboutCoffee = "settings.about.coffee"
        case settingsAboutCoffeeAccessibilityHint = "settings.about.coffee.accessibility_hint"
        case settingsAboutQRCodeTitle = "settings.about.qr_code.title"
        case settingsAboutQRCodeMessage = "settings.about.qr_code.message"
        case settingsAboutQRCodeAccessibilityLabel = "settings.about.qr_code.accessibility_label"
        case settingsAboutQRCodeUnavailable = "settings.about.qr_code.unavailable"
        case settingsAboutClose = "settings.about.close"
        case appUpdateBannerAvailable = "app.update.banner.available"
        case appUpdateBannerLater = "app.update.banner.later"
        case bottomBarSettingsUpdateAvailableHelp = "bottom_bar.settings.update_available.help"
